...
var extractBackgroundStyle = new ExtractTextPlugin(
...
const commonConfig = merge([
    {
        ...
        plugins: [
            ...
            new CopyWebpackPlugin([
                ...
                {
                    from: "node_modules/tinymce/skins/lightgray/fonts/",
                    to: "background/css/fonts/"
                },
                {
                    from: "node_modules/tinymce/skins/lightgray/",
                    to: "pages/tinymce/skins/lightgray/"
                }
            ]),
            new ConcatPlugin({
                uglify: false,
...
module.exports = mode => {
    if (mode === "production") {
        return merge(
            commonConfig,
            build.generateManifestProduction({}),
            productionConfig,
            { mode }
        );
    }
    return merge(commonConfig, developmentConfig, dev.generateManifest({}), {
        mode
    });
};
