...
module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        stylus: {
            development: {
                ...
                files: {
                    "<%= config.dist %>/background/css/installed.css":
                        "<%= config.app %>/background/css/installed.styl",
                    "<%= config.dist %>/background/css/background.css":
                        "<%= config.app %>/background/css/background.styl",

                    "<%= config.dist %>/content/css/content.css":
                        "<%= config.app %>/content/css/content.styl"
                }
            },
            production: {
                options: {
        ...
        compress: {
            all: {
                options: {
                    archive:
                        "build/<%= pkg.name %>-<%= manifestContents.version %>.zip"
                },
                ...
                files: [
                    {
                        ...
                        dot: true,
                        cwd:
                            "<%= config.app %>/../node_modules/font-awesome/fonts/",
                    ...
                    },
                    {
                        ...
                        dot: true,
                        cwd:
                            "<%= config.app %>/../node_modules/tinymce/skins/lightgray/fonts/",
                    ...
                    },
                    {
                        expand: true,
                        cwd:
                            "<%= config.app %>/../node_modules/tinymce/skins/lightgray/",
                        dest:
                            "<%= config.dist %>/pages/tinymce/skins/lightgray",
                        src: ["**"]
                    },
                    {
                        expand: true,
                        ...
                        cwd: config.app,
                        dest: "<%= config.dist %>",
                        src: ["icons/**", "_locales/**", "pages/**", "LICENSE"]
                    }
                ]
            }
        },
    ...
    grunt.registerTask(
        ...
        function() {
            ...
            grunt.file.write(
                config.app + "/background/js/environment.js",
                'var ENV = "development";'
            );
        }
    );
    ...
    grunt.registerTask("test", function(target) {
        grunt.task.run(["jshint", "production", "crx"]);

        if (target === "content") {
            return grunt.task.run(["protractor:contentRemote"]);
        }

        if (target === "background") {
            return grunt.task.run(["protractor:backgroundRemote"]);
        }
    ...
    grunt.registerTask("build", ["production", "compress"]);
    // alias
